...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/ecomxco/engram/blob/main/LICENSE)
...
![Engram dashboard — Overview tab](https://raw.githubusercontent.com/ecomxco/engram/main/docs/screenshot-overview.png)
...
![Engram dashboard — Session Timeline](https://raw.githubusercontent.com/ecomxco/engram/main/docs/screenshot-timeline.png)
...
![Engram dashboard — Full Log](https://raw.githubusercontent.com/ecomxco/engram/main/docs/screenshot-fulllog.png)
...
See [`examples/after-10-sessions/`](https://github.com/ecomxco/engram/tree/main/examples/after-10-sessions) for what a real project looks like.
...
See [server/docs/multi-device.md](https://github.com/ecomxco/engram/blob/main/server/docs/multi-device.md) for git sync, advisory locking, and team workflows.
...
MIT — see [LICENSE](https://github.com/ecomxco/engram/blob/main/LICENSE).
